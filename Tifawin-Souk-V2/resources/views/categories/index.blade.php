    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('categories.create') }}" class="btn add-btn flex items-center">
                    <i class=" fas fa-plus mr-2"></i> Nouvelle Catégorie
                </a>
                <a href="{{ route('dashboard') }}" class="btn btn-primary  px-4 py-2 rounded-lg flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Nombre de Produits</th>
                            <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Créée le</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($categories as $category)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm ">{{ Str::limit($category->description ?? 'Aucune description', 50) }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm ">{{ $category->created_at->format('d/m/Y H:i') }}</td>
